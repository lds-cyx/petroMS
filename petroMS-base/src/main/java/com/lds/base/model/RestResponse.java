...
public class RestResponse<T> {
     ...
     * 签名
     */
    private String signature; // 新增签名字段
    ...
    public RestResponse(int code, String msg,String signature) {
        this.code = code;
        this.msg = msg;
    ...
    public static <T> RestResponse<T> encryptSuccess(T result,String signature) {
        RestResponse<T> response = new RestResponse<T>();
